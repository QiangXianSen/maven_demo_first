...
public class TzAutoProject {
	...
	private static String author = "黄辉业同学";
	private static String qq = "5476465";
	private static String telephone = "546476456";
	private static String email = "1646435464@qq.com";
